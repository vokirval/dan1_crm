...
//Рауты и текста.
const fetchRoute = "/delivery-methods";
const saveRoute = "/delivery-methods";
const deleteRoute = "/delivery-methods";
const pageTitle = "Метод доставки";
const addButtonLabel = "Додати метод доставки";
