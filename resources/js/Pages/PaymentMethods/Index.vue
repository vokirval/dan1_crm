...
//Рауты и текста.
const fetchRoute = "/payment-methods";
const saveRoute = "/payment-methods";
const deleteRoute = "/payment-methods";
const pageTitle = "Метод оплати";
const addButtonLabel = "Додати метод оплати";
